...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def computeActionFromValues(self, state):
        ...
        # FOR ALL ACTIONS IN POSSIBLE ACTIONS FROM CURRENT STATE
        # THE BEST ACTION IN THE GIVEN STATE CALLED POLICY IS EQUAL TO GETQVALUE OUTPUT
        # FINALLY RETURN THE MAX ELEMENT OF POLICY
